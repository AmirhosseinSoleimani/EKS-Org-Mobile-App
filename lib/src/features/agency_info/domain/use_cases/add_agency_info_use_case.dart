...
@injectable
class AddAgencyInfoUseCase {
  const AddAgencyInfoUseCase(this._repository);

  final AgencyInfoRepository _repository;

  Future<ApiResult<String>> call(AddAgencyInfoParamEntity param) {
    return _repository.addAgency(param);
  }
}
