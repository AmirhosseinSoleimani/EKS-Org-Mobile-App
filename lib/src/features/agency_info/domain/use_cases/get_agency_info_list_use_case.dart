...
@injectable
class GetAgencyInfoListUseCase {
  const GetAgencyInfoListUseCase(this._repository);

  final AgencyInfoRepository _repository;

  Future<ApiResult<AgencyInfoPageEntity>> call(AgencyInfoFilterParamEntity param) {
