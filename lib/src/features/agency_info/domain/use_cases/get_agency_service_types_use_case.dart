...
@injectable
class GetAgencyServiceTypesUseCase {
  const GetAgencyServiceTypesUseCase(this._repository);

  final AgencyInfoRepository _repository;

  Future<ApiResult<List<AgencyServiceTypeEntity>>> call(
    AgencyIdParamEntity param,
  ) {
    return _repository.getServiceTypes(param);
  }
}
