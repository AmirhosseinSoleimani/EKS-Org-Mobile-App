...
@injectable
class GetCurrentAgencyPersonsUseCase {
  const GetCurrentAgencyPersonsUseCase(this._repository);

  final AgencyInfoRepository _repository;

  Future<ApiResult<AgencyPersonPageEntity>> call(
    AgencyInfoIdParamEntity param,
  ) {
    return _repository.getCurrentPersons(param);
  }
}
