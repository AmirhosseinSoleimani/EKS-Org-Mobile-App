...
class _VehicleModelFilterSheetState extends State<VehicleModelFilterSheet> {
  ...
  late final TextEditingController _navganController;
  bool? _isActive;
  bool? _hasDepot;
  ...
  void initState() {
    ...
    _navganController =
        TextEditingController(text: widget.initialNavganTypeTitle);
