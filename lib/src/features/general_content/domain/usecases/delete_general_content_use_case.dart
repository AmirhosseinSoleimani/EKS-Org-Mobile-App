...
@lazySingleton
class DeleteGeneralContentUseCase
    extends BaseUseCase<ApiResult<String>, GeneralContentIdParamEntity> {
  DeleteGeneralContentUseCase(this._repository);

  final GeneralContentRepository _repository;

  @override
  Future<ApiResult<String>> call(GeneralContentIdParamEntity param) {
    return _repository.deleteById(param);
  }
}
