...
class _DashboardReportService implements DashboardReportService {
  ...
  Future<BaseSingleResponse<DashboardModel?>> getDashboardData(
    ...
    _data.addAll(body);
    final _options = _setStreamType<BaseSingleResponse<DashboardModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<BaseSingleResponse<ServerDateTimeModel?>> getServerDateTime(
    ...
    _data.addAll(body);
    final _options =
        _setStreamType<BaseSingleResponse<ServerDateTimeModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
