...
class _AuthService implements AuthService {
  ...
  Future<BaseSingleResponse<CurrentSessionModel?>> getCurrentSession(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<BaseSingleResponse<CurrentSessionModel?>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/User/CurrentSession',
            queryParameters: queryParameters,
            data: _data,
          )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseSingleResponse<CurrentSessionModel?> _value;
    try {
      _value = BaseSingleResponse<CurrentSessionModel?>.fromJson(
        _result.data!,
        (json) => json == null
            ? null
            : CurrentSessionModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
