  ...
  static ExcelExportRequest create(List<ShiftEntity> items) {
    return ExcelExportRequest.fromItems<ShiftEntity>(
      ...
      columns: [
        ...
        ExcelExportColumn(title: 'زمان شروع', valueBuilder: (item, _) => item.startTime, width: 16),
        ExcelExportColumn(title: 'زمان پایان', valueBuilder: (item, _) => item.endTime, width: 16),
