...
class _ShiftService implements ShiftService {
  _ShiftService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<dynamic> getByFilter(Map<String, dynamic> body) async {
