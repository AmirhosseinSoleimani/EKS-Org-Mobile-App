...
class InvoiceAgencyObjectionPage extends StatelessWidget {
  const InvoiceAgencyObjectionPage({super.key});

  static const String path = '/invoice-agency-objections';
  static const String name = 'invoice-agency-objections';
...
class _InvoiceAgencyObjectionView extends StatefulWidget {
  const _InvoiceAgencyObjectionView();

  @override
  State<_InvoiceAgencyObjectionView> createState() =>
      _InvoiceAgencyObjectionViewState();
}

class _InvoiceAgencyObjectionViewState
    extends State<_InvoiceAgencyObjectionView> {
