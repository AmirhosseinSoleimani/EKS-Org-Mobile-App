...
@injectable
class FinalizeCustomerInvoiceUseCase {
  const FinalizeCustomerInvoiceUseCase(this._repository);

  final CustomerInvoiceRepository _repository;

  Future<ApiResult<String>> call(InvoiceDetailsParamEntity param) {
    return _repository.finalizeInvoice(param);
  }
}
