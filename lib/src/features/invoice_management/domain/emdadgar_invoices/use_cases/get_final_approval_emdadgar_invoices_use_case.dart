...
@injectable
class GetFinalApprovalEmdadgarInvoicesUseCase {
  const GetFinalApprovalEmdadgarInvoicesUseCase(this._repository);
  ...
  Future<ApiResult<EmdadgarInvoicePageEntity>> call(
    ...
    return _repository.getFinalApprovalInvoices(param);
  }
}
