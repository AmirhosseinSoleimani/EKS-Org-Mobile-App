...
@injectable
class GetCustomerInvoiceDocumentUrlsUseCase {
  const GetCustomerInvoiceDocumentUrlsUseCase(this._repository);

  final InvoiceCommonRepository _repository;

  Future<ApiResult<InvoiceDocumentUrlsEntity>> call(String invoiceGuid) {
    return _repository.getCustomerDocumentUrls(invoiceGuid);
  }
}
