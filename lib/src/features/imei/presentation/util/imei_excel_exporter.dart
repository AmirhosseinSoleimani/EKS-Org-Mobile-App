...
class ImeiExcelExporter {
  const ImeiExcelExporter._();

  static Future<String> export(List<ImeiInfoEntity> items) async {
    Directory? directory;
    try {
    ...
    final timestamp = DateTime.now()
        ...
        .replaceAll(':', '-')
        .replaceAll('.', '-');
    final file = File('${directory.path}/imei-report-$timestamp.xls');
    await file.writeAsString(_buildWorkbook(items), flush: true);
    return file.path;
  }

  static String _buildWorkbook(List<ImeiInfoEntity> items) {
