...
@lazySingleton
class DeleteGradePatternReferenceUseCase
    extends BaseUseCase<ApiResult<void>, int> {
  DeleteGradePatternReferenceUseCase(this._repository);

  final GradePatternRepository _repository;

  @override
  Future<ApiResult<void>> call(int arg) {
    return _repository.deleteReferenceById(arg);
  }
}
