...
class HomeServiceEvaluationPage extends StatelessWidget {
  const HomeServiceEvaluationPage({super.key});
        ...
        child: Scaffold(
          ...
          body: ScrollConfiguration(
            ...
            child: BlocBuilder<HomeServiceEvaluationCubit,
                HomeServiceEvaluationState>(
              builder: (context, state) {
                final showFullPageLoading = state.maybeWhen(
                  loading: (data) => data.selectedRequest == null,
                  orElse: () => false,
                );
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      ExpandableSection(
                        isExpanded: false,
                        header: RequestStatusSection(request: pageData
                            .selectedRequest),
                      ...
                      ExpandableSection(
                        ...
                        child: SizedBox(
                          ...
                          child: InkwellButtonWidget(
                            ...
                            splashColor: ServiceType.homeService.serviceColor
                                .withAlpha(50),
