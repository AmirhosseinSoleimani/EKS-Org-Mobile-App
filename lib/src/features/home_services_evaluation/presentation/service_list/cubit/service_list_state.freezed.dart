...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  idle,TResult Function()?  loading,TResult Function()?  success,TResult Function( DialogDataModel dialogDataModel)?  error,TResult Function()?  getServiceLoading,TResult Function()?  getServiceSuccess,TResult Function()?  selectServiceLoading,TResult Function()?  selectServiceSuccess,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ServiceListStateIdleState() when idle != null:
...
return error(_that.dialogDataModel);case ServiceListStateGetServiceLoadingState() when getServiceLoading != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  idle,required TResult Function()  loading,required TResult Function()  success,required TResult Function( DialogDataModel dialogDataModel)  error,required TResult Function()  getServiceLoading,required TResult Function()  getServiceSuccess,required TResult Function()  selectServiceLoading,required TResult Function()  selectServiceSuccess,}) {final _that = this;
switch (_that) {
case ServiceListStateIdleState():
...
return error(_that.dialogDataModel);case ServiceListStateGetServiceLoadingState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  idle,TResult? Function()?  loading,TResult? Function()?  success,TResult? Function( DialogDataModel dialogDataModel)?  error,TResult? Function()?  getServiceLoading,TResult? Function()?  getServiceSuccess,TResult? Function()?  selectServiceLoading,TResult? Function()?  selectServiceSuccess,}) {final _that = this;
switch (_that) {
case ServiceListStateIdleState() when idle != null:
return idle();case ServiceListStateLoadingState() when loading != null:
return loading();case ServiceListStateSuccessState() when success != null:
...
class ServiceListStateErrorState implements ServiceListState {
  const ServiceListStateErrorState({required this.dialogDataModel});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ServiceListStateErrorState&&const DeepCollectionEquality().equals(other.dialogDataModel, dialogDataModel));
}
...
@override
String toString() {
  return 'ServiceListState.error(dialogDataModel: $dialogDataModel)';
}
