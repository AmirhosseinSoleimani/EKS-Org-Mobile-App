...
class HomeServiceSearchPartPage extends BaseStatelessPage {
  ...
  Widget body(BuildContext context) {
    return BlocProvider(
      create: (_) {
        ...
        bloc.initState(laborIndex: laborIndex, serviceIndex: serviceIndex);
        return bloc;
      },
      child: Builder(
          builder: (context) {
          ...
          return Column(
            ...
            children: [
              EkTextField(
                ...
                height: 35,
                controller: context.read<HomeServicePartCubit>().searchPartController,
                title: 'قطعه',
                mandatory: true,
                onChanged: context.read<HomeServicePartCubit>().onSearchPartChanged,
              ),
              Space.h16,
              Expanded(
                flex: 5,
                                          ...
                                          onTap: () {
                                            if (cubit.partResponseListSubject.valueOrNull?[index]?.serial != null) {
                                              Navigator.of(context).push(
                                                MaterialPageRoute(builder: (_) => HomeServicePartPage(
