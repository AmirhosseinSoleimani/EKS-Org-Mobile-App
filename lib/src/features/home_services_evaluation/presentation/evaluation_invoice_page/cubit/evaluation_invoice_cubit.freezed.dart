...
/// @nodoc
mixin _$EvaluationInvoiceState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EvaluationInvoiceState);
}
...
/// @nodoc
class $EvaluationInvoiceStateCopyWith<$Res>  {
$EvaluationInvoiceStateCopyWith(EvaluationInvoiceState _, $Res Function(EvaluationInvoiceState) __);
}


/// Adds pattern-matching-related methods to [EvaluationInvoiceState].
extension EvaluationInvoiceStatePatterns on EvaluationInvoiceState {
...
class _Idle implements EvaluationInvoiceState {
  const _Idle();
...
@override
String toString() {
  return 'EvaluationInvoiceState.idle()';
}
...
class _Loading implements EvaluationInvoiceState {
  const _Loading();
...
@override
String toString() {
  return 'EvaluationInvoiceState.loading()';
}
...
class _Loaded implements EvaluationInvoiceState {
  const _Loaded();
...
@override
String toString() {
  return 'EvaluationInvoiceState.loaded()';
}
...
class _Error implements EvaluationInvoiceState {
  const _Error({required this.message});
  

 final  BottomSheetMessageModel message;

/// Create a copy of EvaluationInvoiceState
...
@override
String toString() {
  return 'EvaluationInvoiceState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $EvaluationInvoiceStateCopyWith<$Res> {
...
class _ConnectionError implements EvaluationInvoiceState {
...
@override
String toString() {
  return 'EvaluationInvoiceState.connectionError()';
}
...
class _SubmitLoading implements EvaluationInvoiceState {
...
@override
String toString() {
  return 'EvaluationInvoiceState.submitLoading()';
}
...
class _SubmitSuccess implements EvaluationInvoiceState {
...
@override
String toString() {
  return 'EvaluationInvoiceState.submitSuccess()';
}
