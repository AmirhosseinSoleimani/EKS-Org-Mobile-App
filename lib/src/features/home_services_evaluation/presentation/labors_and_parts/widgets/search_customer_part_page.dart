...
class SearchCustomerPartPage extends BaseStatelessPage {
  const SearchCustomerPartPage({super.key, required this.serviceIndex, required this.laborIndex, required this.customerPartIndex});
          ...
          return Column(
            ...
            children: [
              EkTextField(
                ...
                onChanged: (value) {
                  if(value.length >= 3) {
                    cubit.getCustomerPart(value: value, laborIndex: laborIndex, serviceIndex: serviceIndex);
                  }
                },
              ),
              Space.h16,
