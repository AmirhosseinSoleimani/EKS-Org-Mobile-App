...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  idle,TResult Function()?  loading,TResult Function()?  success,TResult Function( DialogDataModel dialogDataModel)?  error,TResult Function()?  submitLoading,TResult Function()?  submitSuccess,TResult Function( DialogDataModel dialogDataModel)?  submitError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case HomeServiceEvaluationFirstStepIdleState() when idle != null:
...
return error(_that.dialogDataModel);case HomeServiceEvaluationFirstStepSubmitLoadingState() when submitLoading != null:
...
return submitError(_that.dialogDataModel);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  idle,required TResult Function()  loading,required TResult Function()  success,required TResult Function( DialogDataModel dialogDataModel)  error,required TResult Function()  submitLoading,required TResult Function()  submitSuccess,required TResult Function( DialogDataModel dialogDataModel)  submitError,}) {final _that = this;
switch (_that) {
case HomeServiceEvaluationFirstStepIdleState():
...
return error(_that.dialogDataModel);case HomeServiceEvaluationFirstStepSubmitLoadingState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  idle,TResult? Function()?  loading,TResult? Function()?  success,TResult? Function( DialogDataModel dialogDataModel)?  error,TResult? Function()?  submitLoading,TResult? Function()?  submitSuccess,TResult? Function( DialogDataModel dialogDataModel)?  submitError,}) {final _that = this;
switch (_that) {
case HomeServiceEvaluationFirstStepIdleState() when idle != null:
return idle();case HomeServiceEvaluationFirstStepLoadingState() when loading != null:
return loading();case HomeServiceEvaluationFirstStepSuccessState() when success != null:
...
class HomeServiceEvaluationFirstStepErrorState implements HomeServiceEvaluationFirstStepState {
  const HomeServiceEvaluationFirstStepErrorState({required this.dialogDataModel});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeServiceEvaluationFirstStepErrorState&&const DeepCollectionEquality().equals(other.dialogDataModel, dialogDataModel));
}
...
@override
String toString() {
  return 'HomeServiceEvaluationFirstStepState.error(dialogDataModel: $dialogDataModel)';
}
...
class HomeServiceEvaluationFirstStepSubmitErrorState implements HomeServiceEvaluationFirstStepState {
  const HomeServiceEvaluationFirstStepSubmitErrorState({required this.dialogDataModel});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeServiceEvaluationFirstStepSubmitErrorState&&const DeepCollectionEquality().equals(other.dialogDataModel, dialogDataModel));
}
...
@override
String toString() {
  return 'HomeServiceEvaluationFirstStepState.submitError(dialogDataModel: $dialogDataModel)';
}
