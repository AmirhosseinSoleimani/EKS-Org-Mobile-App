...
/// @nodoc
mixin _$ChassisRequestHistoryState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChassisRequestHistoryState);
}
...
@override
String toString() {
  return 'ChassisRequestHistoryState()';
}
...
/// @nodoc
class $ChassisRequestHistoryStateCopyWith<$Res>  {
$ChassisRequestHistoryStateCopyWith(ChassisRequestHistoryState _, $Res Function(ChassisRequestHistoryState) __);
}


/// Adds pattern-matching-related methods to [ChassisRequestHistoryState].
extension ChassisRequestHistoryStatePatterns on ChassisRequestHistoryState {
...
class _Idle implements ChassisRequestHistoryState {
  const _Idle();
...
class _Loading implements ChassisRequestHistoryState {
  const _Loading();
...
class _Loaded implements ChassisRequestHistoryState {
  const _Loaded();
...
class _Error implements ChassisRequestHistoryState {
  const _Error({required this.message});
  

 final  BottomSheetMessageModel message;

/// Create a copy of ChassisRequestHistoryState
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ChassisRequestHistoryStateCopyWith<$Res> {
...
class _LoadingMore implements ChassisRequestHistoryState {
  const _LoadingMore();
...
class _ConnectionError implements ChassisRequestHistoryState {
