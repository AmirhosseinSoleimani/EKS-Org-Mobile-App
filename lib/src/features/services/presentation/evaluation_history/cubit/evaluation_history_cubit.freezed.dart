...
/// @nodoc
mixin _$EvaluationHistoryState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EvaluationHistoryState);
}
...
/// @nodoc
class $EvaluationHistoryStateCopyWith<$Res>  {
$EvaluationHistoryStateCopyWith(EvaluationHistoryState _, $Res Function(EvaluationHistoryState) __);
}


/// Adds pattern-matching-related methods to [EvaluationHistoryState].
extension EvaluationHistoryStatePatterns on EvaluationHistoryState {
...
class _Idle implements EvaluationHistoryState {
  const _Idle();
...
class _Loading implements EvaluationHistoryState {
  const _Loading();
...
class _Loaded implements EvaluationHistoryState {
  const _Loaded();
...
class _Error implements EvaluationHistoryState {
  const _Error({required this.message});
  

 final  BottomSheetMessageModel message;

/// Create a copy of EvaluationHistoryState
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $EvaluationHistoryStateCopyWith<$Res> {
...
class _LoadingMore implements EvaluationHistoryState {
  const _LoadingMore();
...
class _ConnectionError implements EvaluationHistoryState {
