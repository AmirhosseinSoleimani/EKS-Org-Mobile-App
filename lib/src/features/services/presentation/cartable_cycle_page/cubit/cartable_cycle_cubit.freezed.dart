...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CartableCycleState);
}
...
/// @nodoc
class $CartableCycleStateCopyWith<$Res>  {
$CartableCycleStateCopyWith(CartableCycleState _, $Res Function(CartableCycleState) __);
}


/// Adds pattern-matching-related methods to [CartableCycleState].
extension CartableCycleStatePatterns on CartableCycleState {
...
class _Idle implements CartableCycleState {
  const _Idle();
...
class _Loading implements CartableCycleState {
  const _Loading();
...
class _Loaded implements CartableCycleState {
  const _Loaded();
...
class _Error implements CartableCycleState {
  const _Error({required this.message});
  

 final  BottomSheetMessageModel message;

/// Create a copy of CartableCycleState
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $CartableCycleStateCopyWith<$Res> {
...
class _LoadingMore implements CartableCycleState {
  const _LoadingMore();
...
class _ConnectionError implements CartableCycleState {
