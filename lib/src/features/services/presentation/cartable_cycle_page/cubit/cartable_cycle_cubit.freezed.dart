...
class _LoadedMore implements CartableCycleState {
  const _LoadedMore();
...
@override
String toString() {
  return 'CartableCycleState.loadedMore()';
}
...
class _LoadMoreError implements CartableCycleState {
...
@override
String toString() {
  return 'CartableCycleState.loadMoreError(message: $message)';
}
...
/// @nodoc
abstract mixin class _$LoadMoreErrorCopyWith<$Res> implements $CartableCycleStateCopyWith<$Res> {
