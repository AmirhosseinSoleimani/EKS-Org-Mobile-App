...
/// @nodoc
mixin _$ChangeHomeServiceRequestAddressState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChangeHomeServiceRequestAddressState);
}
...
@override
String toString() {
  return 'ChangeHomeServiceRequestAddressState()';
}
...
/// @nodoc
class $ChangeHomeServiceRequestAddressStateCopyWith<$Res>  {
$ChangeHomeServiceRequestAddressStateCopyWith(ChangeHomeServiceRequestAddressState _, $Res Function(ChangeHomeServiceRequestAddressState) __);
}


/// Adds pattern-matching-related methods to [ChangeHomeServiceRequestAddressState].
extension ChangeHomeServiceRequestAddressStatePatterns on ChangeHomeServiceRequestAddressState {
...
class _Idle implements ChangeHomeServiceRequestAddressState {
  const _Idle();
...
@override
String toString() {
  return 'ChangeHomeServiceRequestAddressState.idle()';
}
...
class _Loading implements ChangeHomeServiceRequestAddressState {
  const _Loading();
...
@override
String toString() {
  return 'ChangeHomeServiceRequestAddressState.loading()';
}
...
class _Loaded implements ChangeHomeServiceRequestAddressState {
  const _Loaded();
...
@override
String toString() {
  return 'ChangeHomeServiceRequestAddressState.loaded()';
}
...
class _Error implements ChangeHomeServiceRequestAddressState {
  const _Error({required this.message});
  

 final  BottomSheetMessageModel message;

/// Create a copy of ChangeHomeServiceRequestAddressState
...
@override
String toString() {
  return 'ChangeHomeServiceRequestAddressState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ChangeHomeServiceRequestAddressStateCopyWith<$Res> {
...
class _ConnectionError implements ChangeHomeServiceRequestAddressState {
...
@override
String toString() {
  return 'ChangeHomeServiceRequestAddressState.connectionError()';
}
...
class _SubmitLoading implements ChangeHomeServiceRequestAddressState {
...
@override
String toString() {
  return 'ChangeHomeServiceRequestAddressState.submitLoading()';
}
...
class _SubmitSuccess implements ChangeHomeServiceRequestAddressState {
...
@override
String toString() {
  return 'ChangeHomeServiceRequestAddressState.submitSuccess(message: $message)';
}
...
/// @nodoc
abstract mixin class _$SubmitSuccessCopyWith<$Res> implements $ChangeHomeServiceRequestAddressStateCopyWith<$Res> {
