...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NonCooperationState);
}
...
/// @nodoc
class $NonCooperationStateCopyWith<$Res>  {
$NonCooperationStateCopyWith(NonCooperationState _, $Res Function(NonCooperationState) __);
}


/// Adds pattern-matching-related methods to [NonCooperationState].
extension NonCooperationStatePatterns on NonCooperationState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  idle,TResult Function()?  loading,TResult Function()?  loaded,TResult Function( BottomSheetMessageModel message)?  error,TResult Function()?  loadingMore,TResult Function()?  connectionError,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Idle() when idle != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  idle,required TResult Function()  loading,required TResult Function()  loaded,required TResult Function( BottomSheetMessageModel message)  error,required TResult Function()  loadingMore,required TResult Function()  connectionError,}) {final _that = this;
switch (_that) {
case _Idle():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  idle,TResult? Function()?  loading,TResult? Function()?  loaded,TResult? Function( BottomSheetMessageModel message)?  error,TResult? Function()?  loadingMore,TResult? Function()?  connectionError,}) {final _that = this;
switch (_that) {
case _Idle() when idle != null:
return idle();case _Loading() when loading != null:
return loading();case _Loaded() when loaded != null:
...
class _Idle implements NonCooperationState {
  const _Idle();
...
@override
String toString() {
  return 'NonCooperationState.idle()';
}
...
class _Loading implements NonCooperationState {
  const _Loading();
...
@override
String toString() {
  return 'NonCooperationState.loading()';
}
...
class _Loaded implements NonCooperationState {
  const _Loaded();
...
@override
String toString() {
  return 'NonCooperationState.loaded()';
}
...
class _Error implements NonCooperationState {
  const _Error({required this.message});
  

 final  BottomSheetMessageModel message;

/// Create a copy of NonCooperationState
...
@override
String toString() {
  return 'NonCooperationState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $NonCooperationStateCopyWith<$Res> {
...
class _LoadingMore implements NonCooperationState {
  const _LoadingMore();
...
@override
String toString() {
  return 'NonCooperationState.loadingMore()';
}
...
class _ConnectionError implements NonCooperationState {
...
@override
String toString() {
  return 'NonCooperationState.connectionError()';
}
