        ...
        children: [
                        ...
                        return TimelineItemCard(
                          children: [
                            ...
                            KeyValueRow(
                              ...
                              label: '',
                              value: _displayText(item.insertUserName),
                              boldValue: true,
                              mainAxisAlignment: MainAxisAlignment.start,
                            ),
                            Space.h8,
                            BodySmallText(
                              text: _displayText(item.description),
          ...
          BlocBuilder<RequestStatusHistoryCubit, RequestStatusHistoryState>(
            builder: (context, state) {
              ...
              final loadingMore = state.whenOrNull(loadingMore: () => true);
              if (loadingMore == true) {
                return Padding(
                ...
                child: TextButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Space.w4,
                      Icon(Icons.expand_more, color: actionColor),
                    ],
                  ),
                ),
              );
