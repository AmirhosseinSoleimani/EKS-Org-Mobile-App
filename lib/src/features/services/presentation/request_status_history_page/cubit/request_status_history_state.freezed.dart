...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RequestStatusHistoryState);
}
...
@override
String toString() {
  return 'RequestStatusHistoryState()';
}
...
/// @nodoc
class $RequestStatusHistoryStateCopyWith<$Res>  {
$RequestStatusHistoryStateCopyWith(RequestStatusHistoryState _, $Res Function(RequestStatusHistoryState) __);
}


/// Adds pattern-matching-related methods to [RequestStatusHistoryState].
extension RequestStatusHistoryStatePatterns on RequestStatusHistoryState {
...
class _Idle implements RequestStatusHistoryState {
  const _Idle();
...
class _Loading implements RequestStatusHistoryState {
  const _Loading();
...
class _Loaded implements RequestStatusHistoryState {
  const _Loaded();
...
class _Error implements RequestStatusHistoryState {
  const _Error({required this.message});
  

 final  BottomSheetMessageModel message;

/// Create a copy of RequestStatusHistoryState
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $RequestStatusHistoryStateCopyWith<$Res> {
...
class _LoadingMore implements RequestStatusHistoryState {
  const _LoadingMore();
...
class _LoadedMore implements RequestStatusHistoryState {
  const _LoadedMore();
...
class _LoadMoreError implements RequestStatusHistoryState {
...
/// @nodoc
abstract mixin class _$LoadMoreErrorCopyWith<$Res> implements $RequestStatusHistoryStateCopyWith<$Res> {
...
class _ConnectionError implements RequestStatusHistoryState {
