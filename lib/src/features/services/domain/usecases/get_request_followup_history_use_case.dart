...
@lazySingleton
class GetRequestFollowupHistoryUseCase extends BaseUseCase<ApiResult<FollowupEntity>, RequestOperationParamEntity> {
  final RequestRepository _repository;

  GetRequestFollowupHistoryUseCase(this._repository);

  @override
  Future<ApiResult<FollowupEntity>> call(arg) async {
