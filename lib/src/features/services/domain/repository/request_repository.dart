...
abstract class RequestRepository {
  Future<ApiResult<List<ReliefRequestEntity>>> getReliefRequestList(RequestFilterParamEntity param);

  Future<ApiResult<ReliefRequestEntity?>> getReliefRequestById(int id);

  Future<ApiResult<List<HomeServiceRequestEntity>>> getHomeServiceRequestList(RequestFilterParamEntity param);
