...
class _EvaluationService implements EvaluationService {
  ...
  Future<BaseSingleResponse<dynamic>> insertTrackerEvaluation(
    ...
    final _options = _setStreamType<BaseSingleResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/AidServiceEvaluation/InsertTrackerEvaluation',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<BaseSingleResponse<dynamic>> insertInvoiceOperatorEvaluation(
    ...
    final _options = _setStreamType<BaseSingleResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/AidServiceEvaluation/InsertInvoiceOperatorEvaluation',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<BaseSingleResponse<dynamic>> insertHesabdariEvaluation(
    ...
    final _options = _setStreamType<BaseSingleResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/AidServiceEvaluation/InsertHesabdariEvaluation',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<BaseSingleResponse<dynamic>> insertDaraeiEvaluation(
    ...
    final _options = _setStreamType<BaseSingleResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/AidServiceEvaluation/InsertDaraeiEvaluation',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<BaseSingleResponse<dynamic>> invoiceOperatorEvaluationAccept(
    ...
    final _options = _setStreamType<BaseSingleResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/AidServiceEvaluation/InvoiceOperatorEvaluationAccept',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<BaseSingleResponse<dynamic>> amendmentInvoiceByHesabdari(
    ...
    final _options = _setStreamType<BaseSingleResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/AidServiceEvaluation/AmendmentInvoiceByHesabdari',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<BaseSingleResponse<dynamic>> amendmentInvoiceByDaraei(
    ...
    final _options = _setStreamType<BaseSingleResponse<dynamic>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/AidServiceEvaluation/AmendmentInvoiceByDaraei',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<BaseListResponse<RepresentationModel>> getRepresentationList(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<BaseListResponse<RepresentationModel>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseListResponse<RepresentationModel> _value;
    try {
      _value = BaseListResponse<RepresentationModel>.fromJson(
        _result.data!,
        (json) => RepresentationModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
