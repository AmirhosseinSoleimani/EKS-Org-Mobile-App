...
@lazySingleton
class GetPartListUseCase
    extends BaseUseCase<ApiResult<List<PartEntity>>, PartListParamEntity> {
  EvaluationRepository evaluationRepository;

  GetPartListUseCase(this.evaluationRepository);

  @override
  Future<ApiResult<List<PartEntity>>> call(PartListParamEntity arg) async {
    return await evaluationRepository.getPartList(arg);
  }
}
