...
class InvoicePresentationFormatter {
  ...
  static String amount(num? value) {
    ...
    final normalized = value is int ? value.toString() : value.toStringAsFixed(0);
    return _withCommas(normalized);
  }

  static String rial(num? value) {
    if (value == null) return '---';
    final formatted = amount(value);
