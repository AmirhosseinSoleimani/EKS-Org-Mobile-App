...
class _MapService implements MapService {
  ...
  Future<LocationToAddressResponseModel?> fetchLocationToAddress(
    ...
    final _options = _setStreamType<LocationToAddressResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AddressToLocationResponseModel?> fetchAddressToLocation(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AddressToLocationResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<BaseSingleResponse<RouteDataModel>> getRoute(
    ...
    _data.addAll(query);
    final _options = _setStreamType<BaseSingleResponse<RouteDataModel>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
