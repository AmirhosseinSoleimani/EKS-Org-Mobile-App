...
@lazySingleton
class GetPreInvoiceUseCase extends BaseUseCase<ApiResult<InvoiceEntity?>, ServiceInvoiceParamEntity?> {
  GetPreInvoiceUseCase(this._repository);

  final InvoiceRepository _repository;

  @override
  Future <ApiResult<InvoiceEntity?>> call(arg) async{
    final result = _repository.getPreInvoice(arg);
    return result;
  }
}
