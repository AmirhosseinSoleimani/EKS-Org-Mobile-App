...
@lazySingleton
class FetchPreInvoiceOnTheFlyUseCase extends BaseUseCase<ApiResult<InvoiceResponseEntity?>, ServiceInvoiceRequestEntity?> {
  FetchPreInvoiceOnTheFlyUseCase(this._repository);

  final InvoiceRepository _repository;

  @override
  Future <ApiResult<InvoiceResponseEntity?>> call(arg) async{
    final result = _repository.fetchPreInvoiceOnTheFly(arg);
    return result;
  }
}
